  ...
  return (
    <>
      <div className="flex items-center justify-center w-full">
        <div className=" bg-background h-12 min-[445px]:h-8 px-1 my-auto rounded-full ring-1 ring-inset ring-accent min-[445px]:max-w-[212px] max-w-[150px] w-full flex justify-center items-center">
          <Link
