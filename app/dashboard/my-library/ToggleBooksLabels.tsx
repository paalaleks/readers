...
export default function ToggleBooksLabels() {
  ...
  return (
    <div className=" bg-background h-8 px-1 my-auto rounded-full ring-1 ring-inset ring-accent max-w-[160px] xs:max-w-52 w-full flex justify-around items-center">
      <Link
