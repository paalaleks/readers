...
export default function HeroSection() {
  return (
    <>
      ...
      />
      <header className="flex flex-col items-center justify-end pb-12 xs:pb-0 xs:justify-center flex-1 screenMinHeight -mt-24 bg-[url('/images/livingroom.png')] object-contain bg-no-repeat bg-bottom">
        ...
        <Button asChild size={"lg"} className="text-lg animate-in mt-6">
