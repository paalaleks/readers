...
export default function HeroSection() {
  return (
    <>
      ...
      />
      <header className="flex flex-col items-center justify-center pb-2 xs:pb-0 xs:justify-center flex-1 screenMinHeight -mt-24 bg-[url('/images/livingroom.png')] bg-cover bg-no-repeat bg-bottom relative top-1">
